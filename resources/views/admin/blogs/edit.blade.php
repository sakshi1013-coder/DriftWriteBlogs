                ...
                <div class="side-card">
                    ...
                    @if($blog->image)
                        ...
                        <img src="{{ asset('storage/' . $blog->image) }}" alt="{{ $blog->title }}"
                            class="current-image-preview" onerror="this.src='{{ asset('images/default-blog.jpg') }}'">
                        <p class="replace-hint">Upload a new image to replace</p>
                    @endif
                    ...
                    <div class="image-upload-zone" id="image-upload-zone">
                        ...
                        <div class="upload-placeholder" id="upload-placeholder">
                            ...
                            <p class="upload-text">{{ $blog->image ? 'Replace Image' : 'Click to upload' }}</p>
...
quill.clipboard.dangerouslyPasteHTML(`{!! addslashes(old('content', $blog->content)) !!}`);
